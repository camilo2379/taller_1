...
<title>Consuta de vehiculo</title>
</head>
<body>
	<div class="site-wrap">
        ...
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
                <h1 class="mb-2">Vehiculo Consultado</h1>
            </div>
          </div>
        </div>
      </div>  
			...
			<div class="col-md-12">
				...
				<table class="table table-bordered table-striped">
					...
					%>
                                        ...
                                        <a href='./paginas/crearVehiculo.jsp' class="btn btn-primary pill px-4 py-2">Crear Nuevo Vehiculo</a>
			</div>
		</div>
