        ...
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
               <%
                  String miNombre =  (String) request.getAttribute("parametroservlet2");
               %>
              <h1 class="mb-2"> El Numero De Venta <%=miNombre%> Ha Sido Registrado</h1>
            </div>
          </div>
        </div>
      </div>  
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            <div class="row">
              <div class="col-md-6">
                <h3 class="footer-heading mb-4 text-white">Menu Rapido</h3>
