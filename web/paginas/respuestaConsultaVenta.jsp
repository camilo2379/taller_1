        ...
        <div class="container">
          <div class="row align-items-center justify-content-center">
            <div class="col-md-7 text-center" data-aos="fade">
                <h1 class="mb-2"> Venta Consultada</h1>
            </div>
          </div>
        </div>
      </div>  
					...
					<%
						for (VentaDTO v : datos) {
							out.print("<tr><td>" + v.getNumero() + "</td><td>" + v.getPrecio_total() + "</td><td>" + v.getId_persona() + "</td><td>"
									+ v.getId_vehiculo() + "</td><td>" + v.getDescripcion() + "</td><td>" + v.getFecha() );
						}
					%>
					</tbody>
				</table>
                                         <a href='./index.html' class="btn btn-primary pill px-4 py-2">Volver</a>
                                        <a href='./paginas/crearVehiculo.jsp' class="btn btn-primary pill px-4 py-2">Crear Nueva Venta</a>
			</div>
		</div>
